...
import com.nightswatch.mediaservice.model.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(MediaAssetNotFoundException ex, HttpServletRequest request) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(buildError(HttpStatus.NOT_FOUND, ex.getMessage(), request.getRequestURI()));
    }

    @ExceptionHandler(UnsupportedMediaUrlException.class)
    public ResponseEntity<ErrorResponse> handleUnsupportedUrl(UnsupportedMediaUrlException ex, HttpServletRequest request) {
